...
export const selectVariants = tv({
    slots: {
        triggerRoot: [
            // base
            'group/trigger min-w-0 shrink-0 bg-white shadow-regular-xs rounded-lg h-[45px] outline-none ring-1 ring-inset ring-[#EDECF1]',
            'text-paragraph-sm text-[#211A30]',
            'flex items-center text-left',
            'transition duration-200 ease-out',
            // hover
            'hover:bg-bg-weak-50',
            // focus
            'focus:shadow-button-important-focus focus:outline-none focus:ring-[#EDECF1]',
    ...
    compoundVariants: [
        //#region default
        {
            ...
            variant: 'default',
            class: {
                triggerRoot: 'h-10 min-h-10 gap-2 rounded-[13px] hover:!bg-[#F6F5F8] shadow-xs border border-[#edecf1] h-[45px] pl-3 pr-2.5',
            },
        },
        {
            size: 'small',
            variant: 'default',
            class: {
                triggerRoot: 'h-9 min-h-9 gap-2 rounded-[13px] hover:!bg-[#F6F5F8] shadow-xs border border-[#edecf1] h-[45px] pl-2.5 pr-2',
            },
        },
        {
            size: 'xsmall',
            variant: 'default',
            class: {
                triggerRoot: 'h-8 min-h-8 gap-1.5 rounded-[13px] hover:!bg-[#F6F5F8] shadow-xs border border-[#edecf1] h-[45px] pl-2 pr-1.5',
            },
        },
        //#endregion
        ...
        //#region compact
        {
            ...
            variant: 'compact',
            class: {
                triggerRoot: 'h-10 gap-1 rounded-10 ',
                triggerIcon: '-ml-0.5',
...
const SelectTrigger = React.forwardRef(({ className, children, ...rest }, forwardedRef) => {
    ...
    (
        ...
        <SelectPrimitives.Portal>
            <SelectPrimitives.Content
                ...
                className={cnExt(
                    // base
                    'relative z-[999] border border-[#edecf1] overflow-hidden rounded-2xl bg-white shadow-regular-md',
                    // widths
    ...
    return (
        <SelectPrimitives.Item
            ...
            className={cnExt(
                ...
                // hover, focus
                'data-[highlighted]:bg-[#F6F5F8] data-[highlighted]:outline-0', // Changed to gray-200
                {
