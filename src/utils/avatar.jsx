...
import { cn, cnExt } from './cn';
import { recursiveCloneChildren } from './recursiveCloneChildren';
import { tv } from './tv';
...
const AvatarRoot = React.forwardRef((props, forwardedRef) => {
  const {
    asChild,
    children,
    size,
...
const AvatarImage = React.forwardRef((props, forwardedRef) => {
  const { asChild, className, size, color, ...rest } = props;
...
function AvatarIndicator(props) {
  const {
    size,
    color,
    className,
...
const AvatarBrandLogo = React.forwardRef((props, forwardedRef) => {
...
function AvatarNotification(props) {
